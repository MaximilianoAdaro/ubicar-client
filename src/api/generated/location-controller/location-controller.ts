...
>(
  ...
  options?: {
    query?: UseQueryOptions<
      AsyncReturnType<typeof getCitiesUsingGET>,
      TError,
      TData
    >;
  ...
  const query = useQuery<
    ...
    TError,
    TData
  >(queryKey, () => getCitiesUsingGET<TQueryFnData>(stateId, requestOptions), {
    enabled: !!stateId,
    ...queryOptions,
  });
...
export const useGetStatesUsingGET = <
  TQueryFnData = StateDTO[],
  TError = unknown,
  TData = TQueryFnData
>(options?: {
  query?: UseQueryOptions<
    AsyncReturnType<typeof getStatesUsingGET>,
    TError,
    TData
  >;
  request?: SecondParameter<typeof customInstance>;
...
>(
  ...
  options?: {
    query?: UseQueryOptions<
      AsyncReturnType<typeof getTownsUsingGET>,
      TError,
      TData
    >;
    request?: SecondParameter<typeof customInstance>;
  ...
  const query = useQuery<
    ...
    TError,
    TData
  >(queryKey, () => getTownsUsingGET<TQueryFnData>(cityId, requestOptions), {
    enabled: !!cityId,
    ...queryOptions,
  });
