...
import { Col, Container, Image, Row, Button, DropdownButton,Dropdown, Form } from "react-bootstrap";
...
export function ListingPage() {
  ...
  return (
    ...
    <Container className={styles.listingPageContainer}>
        <Row>
            <DropdownButton title="For Sale" variant='dark' className={styles.dropdownButtons}>
                <Dropdown.Item href="#/action-1">En Venta</Dropdown.Item>
                <Dropdown.Item href="#/action-2">En Alquiler</Dropdown.Item>
            </DropdownButton>
            <DropdownButton title="Price" variant='dark' className={styles.dropdownButtons}>
        ...
        <Row>
            <Col className={styles.listingPageCol}  id='RightPhoto' md={7}>
                ...
                <Image className={styles.mapImage} src='https://www.geographicguide.com/pictures/argentina-map.jpg'/>
            </Col>
