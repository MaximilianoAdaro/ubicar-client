...
export function ListingFilters({
  ...
  return (
    <div>
      <Grid className={styles.OptionsFilters}>
      ...
      >
        <Grid className={styles.buttons_popover_outer_div}>
      ...
      >
        <Grid className={styles.smaller_popover_outer_div}>
